...
template <> constexpr inline auto Logger::qt_create_metaobjectdata<qt_meta_tag_ZN6LoggerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(const QString &, Logger::LogLevel)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 3 }, { 0x80000000 | 4, 5 },
        }}),
        // Signal 'messageLegacy'
    ...
    QtMocHelpers::UintData qt_enums {
        // enum 'LogLevel'
        QtMocHelpers::EnumData<enum LogLevel>(7, 7, QMC::EnumFlags{}).add({
            {    8, LogLevel::Debug },
            {    9, LogLevel::Info },
            {   10, LogLevel::Warning },
            {   11, LogLevel::Error },
...
void Logger::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->messageLogged((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<Logger::LogLevel>>(_a[2]))); break;
        case 1: _t->messageLegacy((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Logger::*)(const QString & , Logger::LogLevel )>(_a, &Logger::messageLogged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Logger::*)(const QString & )>(_a, &Logger::messageLegacy, 1))
            return;
    }
}
...
// SIGNAL 0
void Logger::messageLogged(const QString & _t1, Logger::LogLevel _t2)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1, _t2);
}

// SIGNAL 1
void Logger::messageLegacy(const QString & _t1)
{
